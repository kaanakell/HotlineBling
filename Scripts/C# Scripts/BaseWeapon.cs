...
public partial class BaseWeapon : Resource, IWeapon
{
	...
	[Export] public Texture2D WeaponSprite { get; protected set; }
	...
	public virtual FireResult Fire(Node2D shooter, Vector2 fromPosition, Vector2 direction)
	{
		...
		var endPoint = PerformRaycast(shooter, fromPosition, finalDirection);
	...
	protected RayResult PerformRaycast(Node2D shooter, Vector2 from, Vector2 dir)
	{
		...
		return new RayResult { Position = from + dir * Range, HitEntity = null };
	}
