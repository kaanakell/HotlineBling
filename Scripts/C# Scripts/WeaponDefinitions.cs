...
public partial class SniperWeapon : BaseWeapon
{
	public SniperWeapon()
	{
		...
		WeaponSprite = GD.Load<Texture2D>("res://UI pack/Sprites/Weapons/Sniper_Texture.tres");
	}
}
...
public partial class SMGWeapon : BaseWeapon
{
	public SMGWeapon()
	{
		...
		WeaponSprite = GD.Load<Texture2D>("res://UI pack/Sprites/Weapons/Uzi_Texture.tres");
	}
}
...
public partial class AssaultRifleWeapon : BaseWeapon
{
	public AssaultRifleWeapon()
	{
		...
		WeaponSprite = GD.Load<Texture2D>("res://UI pack/Sprites/Weapons/AssaultRifle_Texture.tres");
	}
}
...
public partial class ShotgunWeapon : BaseWeapon
{
	...
	public ShotgunWeapon()
	{
		...
		WeaponSprite = GD.Load<Texture2D>("res://UI pack/Sprites/Weapons/Shotgun_Texture.tres");
	}

	public override FireResult Fire(Node2D shooter, Vector2 fromPosition, Vector2 direction)
	{
		...
		for (int i = 0; i < PelletCount; i++)
		{
			...
			var rayData = PerformRaycast(shooter, fromPosition, pelletDir);
